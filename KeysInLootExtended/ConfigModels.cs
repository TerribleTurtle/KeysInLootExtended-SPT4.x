...
{
    /// <summary>
    /// Selects the overarching spawn and economy profile. Valid values include "Balanced", "Bountiful", "Generous", "Refined", "Hardcore Scarcity", "The MusicManiac Classic", "The Loot Piñata", "Disabled", and "Custom".
    /// </summary>
